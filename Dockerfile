...
FROM yaoapp/yao:0.10.3-dev-amd64
ARG VERSION
...
RUN mkdir -p /data/app && curl -fsSL "https://mirrors-1252011659.cos.ap-beijing.myqcloud.com/apps/yaoapp/demo-plm/docker/latest.zip" > /data/app/latest.zip && \
